...
public class VendingMachine {
	...
	// Error message for when the item is null
	 ...
	 * @throws VendingMachineException if the code is invalid or null
	 */
	private int getSlotIndex(String code) throws VendingMachineException {
		if (code == null) {
			throw new VendingMachineException(VendingMachine.CODE_CANNOT_BE_NULL);
		}
	...
	public void addItem(VendingMachineItem item, String code)
		...
		if (item == null) {
			throw new VendingMachineException(VendingMachine.ITEM_CANNOT_BE_NULL);
		}
